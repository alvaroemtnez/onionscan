...
run `go install github.com/alvaroemtnez/onionscan@latest` and then run the binary in `$GOPATH/bin/onionscan`.
...
`onionscan --torProxyAddress=127.0.0.1:9050 notarealhiddenservice.onion`
